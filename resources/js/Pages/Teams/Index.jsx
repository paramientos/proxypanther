    ...
    return (
        <EnterpriseLayout user={auth.user}>
            ...
            <Box mb={6} display="flex" justifyContent="space-between" alignItems="center">
                ...
                <Button leftIcon={<Plus size={16} />} bg="#f97316" color="white" _hover={{ bg: '#ea580c' }} onClick={onCreateOpen}>
                    New Team
                </Button>
            </Box>
            ...
            {allTeams.length === 0 ? (
                <Box bg={bg} p={12} rounded="lg" border="1px solid" borderColor="#242424" textAlign="center">
                    ...
                    <Button bg="#f97316" color="white" _hover={{ bg: '#ea580c' }} onClick={onCreateOpen}>Create your first team</Button>
                </Box>
            ) : (
                            ...
                            <Box key={team.id} bg={bg} rounded="lg" border="1px solid" borderColor="#242424" overflow="hidden">
                                <Box px={5} py={4} borderBottom="1px solid" borderColor="#242424">
                                    <HStack justify="space-between">
                                        <HStack spacing={3}>
                                            <Box p={2} bg="rgba(249,115,22,0.12)" borderRadius="md">
                                                <Icon as={Users} color="#f97316" boxSize={4} />
                                            </Box>
                                            <VStack align="start" spacing={0}>
                                                <HStack>
                                                    <Text fontWeight="semibold" color="white" fontSize="sm">{team.name}</Text>
                                                    {isOwner && <Badge fontSize="10px" bg="rgba(249,115,22,0.15)" color="#f97316">Owner</Badge>}
                                        ...
                                        <HStack spacing={2}>
                                            {auth.user.current_team_id !== team.id && (
                                                <Button size="sm" leftIcon={<LogIn size={13} />} variant="outline"
                                                    borderColor="#333" color="gray.400" _hover={{ borderColor: '#f97316', color: '#f97316' }}
                                            ...
                                            {isOwner && (
                                                <Button size="sm" leftIcon={<Plus size={13} />} variant="ghost"
                                                    color="#f97316" _hover={{ bg: 'rgba(249,115,22,0.1)' }}
                ...
                <ModalContent bg="#161616" border="1px solid" borderColor="#242424">
                    ...
                    <form onSubmit={handleCreate}>
                        ...
                        <ModalFooter borderTop="1px solid" borderColor="#242424">
                            ...
                            <Button bg="#f97316" color="white" _hover={{ bg: '#ea580c' }}
